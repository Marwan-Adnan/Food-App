...
public class DishAdapter extends ArrayAdapter<Dish> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(arr.size()>0){
            ...
            TextView txtDish = convertView.findViewById(R.id.txtDish);
            TextView txtnumitem = convertView.findViewById(R.id.txtnumitem);

            imgDish.setImageResource(d.image);
            txtDish.setText(d.name);
            txtnumitem.setText(d.numItem+"Items");
        }
        return convertView;
    }
}
